...
//  Updated to include scaling by Gabriel Haro on 29-06-16
//  To replace ofxDLib/src/FaceTracker.h
...
namespace ofxDLib {
    ...
    public:
        ...
        void findFaces(const ofPixels& pixels, int scaling, bool bUpscale = false);
        unsigned int size();
