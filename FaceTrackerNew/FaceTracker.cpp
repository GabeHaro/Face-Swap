...
//  Updated with scaling by Gabriel Haro 29-30-16
//  To replace ofxDLib/src/FaceTracker.cpp
...
//--------------------------------------------------------------
void FaceTracker::findFaces(const ofPixels& pixels, int scaling, bool bUpscale) {
    faces.clear();
